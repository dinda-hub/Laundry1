...
class KonfirmasiDataActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnBayar = findViewById(R.id.btn_pembayaran_konfirmasidata)
        btnBatal = findViewById(R.id.btn_batal_konfirmasidata)
        ...
        rvTambahan.adapter = adapterpilihtambahan(listTambahan) { /* kosong */ }

        // Tombol bayar -> tampilkan dialog pembayaran
        btnBayar.setOnClickListener {
            val dialogView = LayoutInflater.from(this).inflate(R.layout.dialogmod_pembayaran, null)
